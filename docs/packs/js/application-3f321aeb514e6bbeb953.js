...
/* harmony import */ var confetti_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! confetti-js */ "./node_modules/confetti-js/dist/index.es.js");
...
$('#rsvp').on('click', function () {
  var confetti = Object(confetti_js__WEBPACK_IMPORTED_MODULE_4__["default"])({
    target: 'rsvp'
  });
  confetti.render();
});
...
function ConfettiGenerator(params) {
  ...
  if (_typeof(appstate.target) != 'object' && typeof appstate.target != 'string') {
    throw new TypeError('The target parameter should be a node or string');
  }

  if (_typeof(appstate.target) == 'object' && (appstate.target === null || !appstate.target instanceof HTMLCanvasElement) || typeof appstate.target == 'string' && (document.getElementById(appstate.target) === null || !document.getElementById(appstate.target) instanceof HTMLCanvasElement)) {
    throw new ReferenceError('The target element does not exist or is not a canvas element');
  } //////////////
  // Properties


  var cv = _typeof(appstate.target) == 'object' ? appstate.target : document.getElementById(appstate.target);
...
/******/ });
//# sourceMappingURL=application-3f321aeb514e6bbeb953.js.map